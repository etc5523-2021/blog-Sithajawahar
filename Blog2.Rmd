---
title: "Japan"
description: "Tokyo Olympics and COVID"
date: "`r Sys.Date()`"
output:
...
wide <- pivot_wider(p1, names_from = year, 
  ...
  rename(covid2020 = "2020",
         covid2021 = "2021") %>% 
  mutate(covid2020 = (covid2020/10000)) %>% 
  mutate(covid2021= (covid2021/10000))
...
theme(
  panel.background = element_rect(fill = "#040405",
                                colour = "lightblue",
...
# Plots
 ...
 a1 <- ggdonutchart(dr1, "totals", label = "event", 
      fill = "event", color = "white",
       palette = c("#E74C3C", "#F1948A", "#FC4E07"))+ ggtitle ("2020")+
...
a2 <-  ggdonutchart(dr2, "totals", label = "event",
      fill = "event", color = "grey",
       palette = c("#E74C3C", "#F1948A", "#FC4E07"))+ ggtitle ("2021")+
