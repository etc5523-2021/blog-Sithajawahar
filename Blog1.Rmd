...
google <- read_csv("Data/Global_Mobility_Report.csv")
...
google_table %>% 
  ...
  formattable(list(area(col = 3:8) ~ color_tile( "#32CD32", "#FF0000")))
...
## References:
 ...
 https://www.business-standard.com/article/companies/explained-why-the-google-mobility-reports-matter-to-policymakers-120070600808_1.html

 https://www.google.com/covid19/mobility/data_documentation.html?hl=en
 
 https://knowyourmeme.com/photos/1514752-google-doodles
